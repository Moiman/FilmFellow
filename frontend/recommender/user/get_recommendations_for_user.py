...
def get_recommendations_for_user(ratings, favourites):
    ...
    movie_id_to_index_coll = np.load(
        "collaborative_filtering/movie_mapper.npy", 
        allow_pickle=True).item()
    movie_index_to_id_coll = np.load(
        "collaborative_filtering/movie_inverse_mapper.npy", 
        allow_pickle=True).item()
    matrix = scipy.sparse.load_npz("collaborative_filtering/sparse_matrix.npz")
